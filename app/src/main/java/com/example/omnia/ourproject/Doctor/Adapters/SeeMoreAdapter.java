...
public class SeeMoreAdapter extends RecyclerView.Adapter<SeeMoreAdapter.MyViewHolder> {
    ...
    public SeeMoreAdapter(Context mContext, List<DoctorClass> albumList, PatientClass aClass ) {
