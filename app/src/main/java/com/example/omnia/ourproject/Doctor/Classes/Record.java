...
public class Record {
    ...
    private String s;
    public Record(Context context,String messageId,String user)
    {
        this.User=user;
        ...
        filePath.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                mDatabase = firebasedatabase.getReferenceFromUrl
                        ("https://jalsa-e9ec7.firebaseio.com/Messages/"+MessageId+"");
    ...
    {
        mDatabase = FirebaseDatabase.getInstance().getReference();
        mDatabase.child("MessagesBetweenDoctorPatient").child(MessageId)
                .child("lastMessageText").setValue("Voice");
        mDatabase.child("MessagesBetweenDoctorPatient").child(MessageId)
